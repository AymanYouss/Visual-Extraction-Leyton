...
def home():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            stamp_detection_path = run_stamp_detection(filepath)
            stamp_removal_path = run_stamp_removal(filepath)

            
            return render_template('results.html', original_image=filepath, check_results_image=check_results_path, text_results_image=text_results_path, signature_image=signature_extractor_path, stamp_detection_image=stamp_detection_path, stamp_removal_image=stamp_removal_path)
        else:
